...
class Player:
    def __init__(self):
        ...
        # AI
        self.decision = None
        self.vision = [0.5, 1, 0.5, 1, 0.5, 1, 0.5, 1, 0.5, 1, 0.5]
        self.fitness = 0
        self.inputs = 11
