...
class Brain:      # här definieras klassen Brain
    ...
    # weight_list = []
            ...
            self.connections.append(connection.Connection(self.nodes[0],
                                                          self.nodes[13],
                                                          random.uniform(-5,5)))
            self.connections.append(connection.Connection(self.nodes[3],
                                                          self.nodes[13],
                                                          random.uniform(-5, 5)))
            # Skapar nod 2
            for i in range(4, 6):
            ...
            for i in range(13,17):
                self.connections.append(connection.Connection(self.nodes[12],
                                                              self.nodes[i],
                                                              random.uniform(-5, 5)))
            ...
            for i in range(18,20):
                self.connections.append(connection.Connection(self.nodes[16],
                                                              self.nodes[i],
                                                              random.uniform(-5, 5)))
            # Ger både nod 1 & 2 i mellanlager 2 bias
            for i in range(18,20):
                self.connections.append(connection.Connection(self.nodes[17],
                                                              self.nodes[i],
                                                              random.uniform(-5, 5)))
            # Output
    ...
    def feed_forward(self, vision):
        ...
        self.nodes[17].output_value = 1
        self.nodes[20].output_value = 1

        for i in range(0, len(self.net)):
            self.net[i].activate()

        # Get output value from output node
        output_value = self.nodes[21].output_value
